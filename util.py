...
def get_estimated_price(location,sqft,bhk,bath):
    # This function now correctly searches for the location without changing its case.
    try:
        # MODIFIED: Removed .lower() to ensure an exact, case-sensitive match.
        loc_index = __data_columns.index(location)
    except:
        # If the location is not found, loc_index will be -1
        loc_index = -1
